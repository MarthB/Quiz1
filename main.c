...
main()
{
    ...
    {
        printf("\nCorrect!\n");
        printf("Question#2: How many eggs does Gaston eat for breakfast?\n");
        scanf(" %s", ansTwo);
        if (toupper (ansTwo) == 'FIVE DOZEN')
        {
        printf("\nCorrect!\n");
        ...
        scanf(" %s", ansSev);
        if (toupper (ansSev) == 'THE DARLINGS' || (ansSev) == 'DARLING')
        {
        printf("\nCorrect!\n");
        ...
        scanf(" %s", ansNine);
        if (toupper (ansNine) == 'THE GARGOYLES' || (ansNine) == 'GARGOYLES')
        {
        printf("\nCorrect!\n");
